...
<hr>Know your Specific Room Id?<br>
	<select name="ROOMIDNUM">
							...
							<option value="36">36</option><option value="32">37</option><option value="33">38</option><option value="34">39</option><option value="40">40</option>
	</select>
...
pg_query("SET search_path=unions;");	
	...
	while ($line = pg_fetch_array($result, null, PGSQL_ASSOC)){
		...
		foreach ($line as $col_value){
			 if($count ==0){
?>      <td>
		<form method="POST" action="/~cs3380f14grp18/reservearoom/reserve.php">
			<input type="hidden" name="id"  value="<?php echo $col_value; ?>"/>
			<input type="hidden" name="action" />
			<input type="submit" value="Reserve" onclick= "location.href ='http://babbage.cs.missouri.edu/~cs3380f14grp18/reservearoom/reserve.php';" />
		</form>
		</td>
<?php
        }
