...
<form method="POST" action="/~cs3380f14grp18/lostandfound/update.php">
        ...
        <table border="1">
<?php
//SESSION_START();        //Starts the session for the page
//if(!isset($_SESSION['user'])){          //If the session has not user account, then the page is redirected to login
//        header('LOCATION: /~bar5z6/cs3380/lab8/index.php');
//}
...
if($_POST['action']=="found"){          //Looks to see if the person wants to edit an entry
...
echo "Is this the item that you want to remove?";
?>
        <form method="POST" action="/~cs3380f14grp18/lostandfound/update.php">
        <input type="submit" value="Yes" name="yesRemove" />
