...
class User extends UActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, email_address, sso, personal_info, last_login, create_time, create_user_id, update_time, update_user_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'items' => array(self::MANY_MANY, 'Item', 'item_claim(user_id, item_id)'),
